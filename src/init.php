<?php
  ...
  function init($title, $path){
    ...
    $page_path = $path;
    init_mysql();
    include_once "$page_path/html/header.html";
  }
  function init_bg($x){
    global $page_bg;
    $page_bg = $x;
  ...
  function init_mysql(){
    global $page_path;
    include_once "$page_path/src/mysql.php";
  }
  function init_nav($x){
    global $page_path, $page_nav;
    $page_nav = $x;
    include_once "$page_path/html/navbar.html";
  }
  function init_footer(){
    global $page_path, $page_bg;
    include_once "$page_path/html/footer.html";
  }
